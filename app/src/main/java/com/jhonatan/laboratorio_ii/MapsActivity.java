...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerDragListener, GoogleMap.OnMarkerClickListener {
    ...
    private void miUbicacion() {
        ...
        if (provider != null) {
            ...
            actualizarUbicacion(location);
            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 2 * 20 * 1000, 10, locationListenerBest);
            Log.d("mejor servidor",provider);
        }
    }
    ...
    private void agregarMarcador(double lat,double lng){
        ...
        LatLng llegada = new LatLng(Double.parseDouble(servicios.getLat()),Double.parseDouble(servicios.getLng()));
        mServicios= mMap.addMarker(new MarkerOptions().position(llegada)
                .title(servicios.getNombre().toString())
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
        String url = getRequestUrl(coordenadas, llegada);
        TaskRequestDirections taskRequestDirections = new TaskRequestDirections();
        taskRequestDirections.execute(url);
    }
